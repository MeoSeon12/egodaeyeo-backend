    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('images', models.FileField(null=True, upload_to='develop/', verbose_name='이미지')),
                ('time_unit', models.CharField(choices=[('시간', '시간'), ('일', '일'), ('월', '월')], max_length=5, null=True, verbose_name='시간 단위')),
