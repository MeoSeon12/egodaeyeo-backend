...
#         # print("방번호", room_id)
#         chat_room = f'user_chatroom_{user_id}_{room_id}'
...
#         other_user_chat_room = f'user_chatroom_{receiver_id}_{room_id}'
#         self_user = sender
...
#         #상대방 채팅창에 send
#         print("상대채팅", other_user_chat_room)
#         await self.channel_layer.group_send(
